...
import Diary from '../Management/teacher/diary/Diary'
import Table from '../Management/teacher/diary/table'
import Render from '../Management/teacher/diary/Render'
import firebase from 'firebase'

class Parent_diary extends Component {
    constructor () {
        super();
